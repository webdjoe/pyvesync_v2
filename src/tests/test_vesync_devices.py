...
from pyvesync_v2 import (VeSyncAir131, VeSyncBulbESL100, VeSyncOutdoorPlug,
...
class TestDeviceList(object):
    ...
    def api_mock(self, caplog):
        ...
        self.vesync_obj = pyvesync_v2.vesync.VeSync('sam@mail.com', 'pass')
    ...
    @patch('pyvesync_v2.vesync.VeSyncOutlet7A')
    @patch('pyvesync_v2.vesync.VeSyncOutlet15A')
    @patch('pyvesync_v2.vesync.VeSyncOutlet10A')
    @patch('pyvesync_v2.vesync.VeSyncWallSwitch')
    @patch('pyvesync_v2.vesync.VeSyncAir131')
    ...
    def test_unknown_device(self, caplog, api_mock):
        ...
        pyvesync_v2.vesync.VSFactory.getDevice(
    ...
    @patch('pyvesync_v2.vesync.VeSyncOutlet7A', autospec=True)
    @patch('pyvesync_v2.vesync.VeSyncOutlet15A', autospec=True)
    @patch('pyvesync_v2.vesync.VeSyncOutlet10A', autospec=True)
    @patch('pyvesync_v2.vesync.VeSyncOutdoorPlug', autospec=True)
    @patch('pyvesync_v2.vesync.VeSyncBulbESL100', autospec=True)
    @patch('pyvesync_v2.vesync.VeSyncWallSwitch', autospec=True)
    @patch('pyvesync_v2.vesync.VeSyncAir131', autospec=True)
    ...
    def test_remove_device(self, outlet_patch, caplog, api_mock):
        ...
        device_exists = pyvesync_v2.vesync.VeSync.remove_dev_test(
    ...
    def test_add_dev_test(self, outdoor_patch, caplog, api_mock):
        ...
        outdoor_inst = pyvesync_v2.VeSyncOutdoorPlug(
