...
class TestApiFunc:
    @patch('pyvesync_v2.helpers.requests.get', autospec=True)
    ...
    @patch('pyvesync_v2.helpers.requests.post', autospec=True)
    ...
    @patch('pyvesync_v2.helpers.requests.put', autospec=True)
    ...
    # @mock.patch('pyvesync_v2.helpers.Helpers.requests.post',
